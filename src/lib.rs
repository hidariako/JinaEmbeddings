// src/lib.rs
/*
 * Core library for JinaEmbeddings
 */
...
#[derive(Debug)]
pub struct JinaEmbeddingsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl JinaEmbeddingsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting JinaEmbeddings processing");
    
    let mut processor = JinaEmbeddingsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = JinaEmbeddingsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = JinaEmbeddingsProcessor::new(false);
